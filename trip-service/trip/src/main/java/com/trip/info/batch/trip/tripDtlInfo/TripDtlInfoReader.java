...
public class TripDtlInfoReader implements ItemReader<TripDto>  {
    ...
    public TripDtlInfoReader(TripService tripService){
        //this.iterator = inputList.iterator();
        this.tripService = tripService;
        log.info(">>>>>>>>>>batchpoint TripDtlInfoReader param2");
        List<TripEntity> dataList = tripService.findByTripCtsNotExistsOrNullOrEmpty();
        log.info(">>>>>>>>>>batchpoint TripDtlInfoReader dataList" + dataList.toString());
        if(dataList != null){
    ...
    public TripDto read()
            throws Exception, UnexpectedInputException, ParseException, NonTransientResourceException {
                log.info(">>>>>>>>>>batchpoint TripDtlInfoReader read");
                log.info(">>>>>>>>>>batchpoint TripDtlInfoReader read iter: "+list.toString());
